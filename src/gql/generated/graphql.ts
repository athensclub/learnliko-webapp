...
export type RecapVocabQuizMutation = { __typename?: 'Mutation', vocabularyRecapCreate: { __typename?: 'VocabularyRecap', id: string, correct: boolean, answerIndex: number } };
...
export type RecapSentenceQuizMutation = { __typename?: 'Mutation', sentenceRecapCreate: { __typename?: 'SentenceRecap', id: string, correct: boolean, answerIndex: number } };
...
export type RecapReadingQuizMutation = { __typename?: 'Mutation', readingRecapCreate: { __typename?: 'ReadingRecap', id: string, totalCorrect: number, answer: Array<{ __typename?: 'ReadingAnswer', userAnswer: number, answerIndex: number, correct: boolean }> } };
...
export type RecapConversationQuizMutation = { __typename?: 'Mutation', conversationRecapCreate: { __typename?: 'ConversationRecap', id: string, correctPercentage: number } };

export type LessonProgressUpdateMutationVariables = Exact<{
  data: LessonProgressUpdateDataInput;
  uid: Scalars['ID']['input'];
}>;


export type LessonProgressUpdateMutation = { __typename?: 'Mutation', lessonProgressUpdate?: { __typename?: 'LessonProgress', id: string } | null };
...
export const LessonProgressUpdateDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"LessonProgressUpdate"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"LessonProgressUpdateDataInput"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"uid"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"lessonProgressUpdate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}},{"kind":"Argument","name":{"kind":"Name","value":"uid"},"value":{"kind":"Variable","name":{"kind":"Name","value":"uid"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<LessonProgressUpdateMutation, LessonProgressUpdateMutationVariables>;
...
export const LessonProgressCurrenciesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"LessonProgressCurrencies"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"lessonId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"uid"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"lessonProgress"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"lessonId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"lessonId"}}},{"kind":"Argument","name":{"kind":"Name","value":"uid"},"value":{"kind":"Variable","name":{"kind":"Name","value":"uid"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"totalExp"}},{"kind":"Field","name":{"kind":"Name","value":"totalCoin"}}]}}]}}]} as unknown as DocumentNode<LessonProgressCurrenciesQuery, LessonProgressCurrenciesQueryVariables>;