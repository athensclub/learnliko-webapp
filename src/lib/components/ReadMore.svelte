<!-- Modified from https://github.com/saideepesh000/svelte-read-more/blob/master/src/ReadMore.svelte
and https://github.com/saideepesh000/svelte-read-more/blob/master/src/utils.js -->
<script lang="ts">
