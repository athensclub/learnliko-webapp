...
<div
	class="flex flex-col rounded-[2vw] py-[1vw] px-[2vw] bg-gradient-to-r from-[#6C80E8] to-[#9BA1FD] relative {clazz}"
>
	<div
		...
		<div class="grid grid-cols-2 gap-[2vw]">
			{#each item.choices as choice, index (choice)}
				<button
					...
					class="w-full min-h-[3vw] font-bold text-[1.4vw] rounded-full {selectedChoice === index
						? 'bg-white'
