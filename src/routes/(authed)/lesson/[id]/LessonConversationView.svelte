					...
					$isMobile
						? `absolute w-full text-[1.3vw] ${
								briefing
									...
									: 'top-0 flex-row items-center justify-between rounded-t-none py-[4vh]'
						  }`
						: `h-fit flex-col ${briefing ? 'w-[36%]' : 'ml-[5%] w-[45%]'}`
				}`}
			>
				{#if briefing}
					...
					<div
						class={`flex flex-row items-center font-bold ${
							$isMobile ? 'mt-[5vw] text-[3.5vw]' : 'mt-[2vw] text-[1.1vw]'
						}`}
					>
						คุณจะได้รับรางวัลสูงสุด
						<div class="mx-[0.5vw] flex flex-row rounded-full bg-white px-[0.5vw] py-[0.3vw]">
							<div
								class="bg-gradient-to-br from-[#C698FF] to-[#6C80E8] bg-clip-text text-[1.05vw] text-transparent"
							>
								{totalExp}
							</div>
							<svg
								class="ml-[0.3vw] w-[2.5vw]"
							...
							<div
								class="ml-[0.5vw] bg-gradient-to-t from-[#FFE08F] via-[#E4AE24] to-[#FFE08F] bg-clip-text text-[1.05vw] text-transparent"
							>
								{totalCoin}
							</div>
							<svg
				...
				{:else if $currentGoal < $chatContext.conversation.details.learner.goal.length}
					<div
						class={`whitespace-pre-wrap text-center font-bold ${
							$isMobile ? 'text-[4vw]' : 'mt-[5vh] text-[1.7vw]'
						}`}
					>
					...
					<div
						class={`mx-auto w-fit rounded-full bg-white ${
							$isMobile
								? 'px-[2vw] py-[1vw] text-[3vw]'
								: 'mb-[5vh] mt-[3vh] px-[1vw] py-[0.3vw] text-[1.35vw]'
						}`}
					>
						<div class="mx-[0.5vw] flex flex-row rounded-full px-[0.5vw] py-[0.3vw]">
							<div
								class="bg-gradient-to-br from-[#C698FF] to-[#6C80E8] bg-clip-text text-[1.05vw] text-transparent"
							>
								{expPerGoal}
					...
					<div
						class="mt-[2vh] flex h-full w-full flex-row items-center justify-center gap-[1vw] text-[1.3vw]"
					>
						<Checkbox
