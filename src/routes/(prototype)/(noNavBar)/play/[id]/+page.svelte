<script lang="ts">
	...
	const data: Lesson = {
		backgroundUrl:
			'https://media.discordapp.net/attachments/1120787872379842711/1128389058180173884/image.png',
		activities: [],
		ambientAudio: 'https://cdn.pixabay.com/audio/2022/07/19/audio_272763b5bb.mp3',
		course: {
		...
		title: 'ทำความรู้จักและทักทาย!',
		view: 0
	};
	const music = new Howl({ src: data.ambientAudio, volume: 0.06, loop: true });
...
>
	...
	<section class="z-10 px-[6.15vw] pt-[3.2vh]">
		<!-- Top bar -->
		<div class="flex w-full flex-row justify-between">
			...
			<button
				...
				class="flex h-fit w-[32vw] flex-row items-center justify-center rounded-full bg-white px-[1.5vw] py-[1vh] text-[4vw] font-bold"
			>
				{#if playingMusic}
					<svg
						class="mr-[2vw] w-[4.5vw]"
						viewBox="0 0 25 25"
						fill="none"
