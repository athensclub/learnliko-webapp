...
<div transition:fade class="relative rounded-[8.21vw] bg-white">
	<!-- show exp & coin -->
	<div
		style="box-shadow: 0px 2px 6px 0px rgba(0, 0, 0, 0.15);"
		class="absolute left-[50%] -translate-x-[50%] -top-[1.9vh] mx-auto flex w-fit flex-row items-center rounded-full bg-white {$isMobile
